...
vectors_path = os.path.join('vectors', 'dbmdz_bert-base-italian-xxl-cased', 'span')
...
for dataset, analysis, n_folds, cv, feature, spatial in args:
    ...
    os.system('python3 simple_decoding.py --dataset {} --analysis {} --n_folds {} --cross_validation {} --feature_selection {} --spatial_analysis {} --vectors_folder {}'.format(dataset, analysis, n_folds, cv, feature, spatial, vectors_path)) 
